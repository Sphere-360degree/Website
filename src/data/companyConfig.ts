export const companyConfig = {
  ...
  aboutStory: {
    ...
    principles: [
      {
        title: 'Pragmatic ROI First',
        description: 'Every recommendation is tied to concrete business results—saving hours of manual time, reducing errors, or unlocking capacity.',
      },
      {
        title: 'Zero Tech Jargon',
        description: 'We explain everything in clear, transparent English that any business owner can understand and evaluate with confidence.',
      },
      {
        title: 'SOPs Before Tech',
        description: 'Automating a chaotic process only creates automated chaos. We help clarify and document your workflows first.',
      },
      {
        title: 'Honest & Unbiased',
        description: "Sometimes the answer isn't AI—it might be a simpler spreadsheet, a refined SOP, or an off-the-shelf tool. We'll tell you honestly.",
      }
    ]
  },
